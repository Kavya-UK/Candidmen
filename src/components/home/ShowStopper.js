...
export default function ShowStopper() {
  return (
    <div className="flex justify-around bg-floralWhite h-[480px] w-full">
      <div>
        <h2 className="not-italic font-Cardo font-normal text-5xl xl:text-7xl leading-[97px] text-black mt-[80px]">
          SHOWSTOPPERS
        </h2>
        <h3 className="not-italic font-Candara font-light text-[40px] lg:text-[50px] xl:text-[64px] leading-[78px] text-black">
