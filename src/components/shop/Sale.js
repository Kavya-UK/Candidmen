  ...
  return (
    <div className="grid grid-cols-8 h-[350px] bg-saleBg p-[20px]">
      <div className=" col-span-2 tablet:col-span-3 pr-5 relative">
        <h2 className="not-italic font-bold text-[40px] leading-[58px] text-white mb-[20px]">
          Preloved Sale
        </h2>
        <CountdownTimer targetDate={dateTimeAfterThreeDays} />
        <div className="mt-[20px] not-italic font-normal text-xl leading-[21px] text-white">
          <span className="relative left-[15px]">Hours</span>
          <span className="relative left-[55px]">Minutes</span>
          <span className="relative left-[85px]">Seconds</span>
        </div>
      </div>
